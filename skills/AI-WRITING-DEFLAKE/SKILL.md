...
> **「每一句話都要有新增資訊。」** ——吳淡如
>
> 8 大地雷只是症狀，這條是病因。任何句子若拿掉後讀者沒有任何資訊損失，就應該被標記為可疑。
> 即使句子沒命中下面 8 條 Rule，只要違反這個 Meta Rule，仍應加 ⚠️ Warning。

**Meta Rule 檢查 3 問**：

1. 這句話拿掉後，讀者會少懂什麼？答不出來 ➜ Flag
2. 這句話跟上一句的差異是什麼？只是換詞 ➜ Flag
3. 這句話能用具體事實/數字/場景替代嗎？能 ➜ Flag「可優化」
