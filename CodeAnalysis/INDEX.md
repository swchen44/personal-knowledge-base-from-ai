...
| [[2026-08-28-CLAUDE-CODE-SETTINGS-JSON-WRITE-OWNERSHIP]] | settings.json 寫入點全追蹤：六類寫入情境（權限/UI/MCP/plugin/遷移/ConfigTool 白名單）、「人是 owner、程式是 recorder」四證據、意圖 vs 狀態雙檔案分工、該誰改決策流程圖 | 2026-08-28 |
