...
links:
  ...
  - "[[2026-03-18-5-AGENT-SKILL-DESIGN-PATTERNS-EVERY-ADK-DEVELOPER-SHOULD-KNOW]]"
github_stars: 30
...
- [[2026-03-17-KARPATHYS-AGENTHUB-A-PRACTICAL-GUIDE-TO-BUILDING-YOUR-FIRST-AI-AGENT-SWARM]] — AgentHub 使用 Go binary + SQLite 的不同架構取向，可對比 GNAP 的零基礎設施設計
- [[2026-03-18-5-AGENT-SKILL-DESIGN-PATTERNS-EVERY-ADK-DEVELOPER-SHOULD-KNOW]] — 代理人技能設計模式，GNAP 的 Task/Run 模型可做為技能執行的追蹤框架
