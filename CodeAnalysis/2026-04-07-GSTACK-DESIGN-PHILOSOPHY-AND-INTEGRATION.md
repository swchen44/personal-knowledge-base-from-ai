...
- [[2026-05-20-CODEX-HOOK-AND-SKILLS-PARAMETERS-DEEP-DIVE]] — Codex 6 條 skill root 路徑（含 `$HOME/.agents/skills/`、`{project}/.agents/skills/`）是 gstack 整合的目標 host 之一；本文補完 skill 結構與掃描細節
